...
const rainbow = 
chalkAnimation.rainbow(' Typescript Quiz ')

let score:number = 0;
let questions:number = 5;
setTimeout(async () =>{
    rainbow.stop()
let quiz :{
    q1 : string,
...
const ans1:string = quiz.q1;
const ans2:string = quiz.q2;
const ans3:string = quiz.q3;
const ans4:string = quiz.q4;
const ans5:string = quiz.q5;
const correct1:string = 'Ambient context';
const correct2:string = 'Any';
const correct3:string = 'Billion-dollar mistake';
const correct4:string = "Bottom type";
const correct5:string = "Generic";
if(ans1 === correct1){
score++
...
if(ans2 === correct2){
    ...
    if( score === questions ){
         ...
         let   percentage:number= score/questions * 100
